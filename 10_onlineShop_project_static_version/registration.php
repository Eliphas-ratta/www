...
<div class="col-md-12">
    <form method="POST"  class="form-row">
        ...
        <div class="form-grou col-md-3">
            ...
            <input class="form-check-input" type="radio" name="sexe" value="m" id="sexem">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="postalCode" name ="postalCode" placeholder="Enter your first postal code">
        </div>
